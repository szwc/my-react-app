...
class ChildCom extends React.Component{
    ...
    componentDidUpdate(prevProps, prevState, snapshot){
        console.log('childCom componentDidUpdate prevProps, prevState, snapshot',prevProps, prevState, snapshot);
    }
    ...
    getSnapshotBeforeUpdate(prevProps, prevState){
        console.log('childCom getSnapshotBeforeUpdate prevProps, prevState',prevProps, prevState);
        return {}
    }
}
export default class LifeCircleDemo extends React.Component {
    ...
    componentDidUpdate(prevProps, prevState, snapshot){
        console.log('parent componentDidUpdate prevProps, prevState, snapshot',prevProps, prevState, snapshot);
    }
    componentWillUnmount(){
    ...
    getSnapshotBeforeUpdate(prevProps, prevState){
        console.log('parent getSnapshotBeforeUpdate prevProps, prevState',prevProps, prevState);
        return {}
    }
}
